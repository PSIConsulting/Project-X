# Experience of Front-End(Android)

* `Front-End 분야(Android) 경험 List 개요`
* `Front-End 분야(Android) 경험 List`
...
### Front-end(Android) 경험 List에 대한 추가 및 보완 의견은 Issues에 EX(Android) Label을 선택하여 의견을 추가해주세요.
...
| 세분류                  | 경험                                                                                             | 학습수준 | 지식/스킬                                   | 카테고리                 |
| -------------------- | ---------------------------------------------------------------------------------------------- | ---- | --------------------------------------- | -------------------- |
| App Component 구성 역량  | Activity를 만들어서 화면에 레이아웃을 만들 수 있다                                                               | Edu1 | Activity                                | App Component 구성 역량  |
| App Component 구성 역량  | Activity에서 다른 Activity로 이동한다                                                                   | Edu1 | Fragment                                | App Component 구성 역량  |
| App Component 구성 역량  | Acitivity 간에 데이터를 전달한다                                                                         | Edu2 | Activity                                | App Component 구성 역량  |
| App Component 구성 역량  | activitiy에 Fragment를 표현한다                                                                      | Edu2 | Fragment                                | App Component 구성 역량  |
| App Component 구성 역량  | Acitivity, Fragment 간 전환시 Intent를 통해서 데이터를 전달한다                                                | Edu2 | Intent                                  | App Component 구성 역량  |
| App Component 구성 역량  | Activity에 life cycle을 이해하고 있다                                                                  | Edu3 | Activity                                | App Component 구성 역량  |
| App Component 구성 역량  | Broadcast Receiver를 만들어서 이벤트를 처리 한다                                                            | Edu3 | Broadcast Receiver                      | App Component 구성 역량  |
| App Component 구성 역량  | LiveData를 적용해서 기능을 구현한다                                                                        | Edu3 | Components-LiveData                     | App Component 구성 역량  |
| App Component 구성 역량  | 하나의 fragment에서 다른 fragment로 이동한다                                                               | Edu3 | Fragment                                | App Component 구성 역량  |
| App Component 구성 역량  | Serializable 또는 Parcelable등의 기법을 적용해서 Intent를 통해 데이터를 전달한다                                     | Edu3 | Intent                                  | App Component 구성 역량  |
| App Component 구성 역량  | Lifecycle을 고려한 문제 없는 데이터 전달 코드를 작성한다                                                           | Edu4 | Activity                                | App Component 구성 역량  |
| App Component 구성 역량  | LifeCycle Owner를 적용해서 필요한 행동을 정의해서 구현한다                                                        | Edu4 | Components-LifeCycle                    | App Component 구성 역량  |
| App Component 구성 역량  | fragment의 life cycle을 이해하고 있다                                                                  | Edu4 | Fragment                                | App Component 구성 역량  |
| App Component 구성 역량  | PendingIntent를 적절한 용도에 따라서 적용한다                                                                | Edu4 | Intent                                  | App Component 구성 역량  |
| App Component 구성 역량  | App의 중단없는 데이터 처리를 위한 sticky한 서비스를 구현한다                                                         | Edu4 | Service                                 | App Component 구성 역량  |
| App Component 구성 역량  | File을 저장하고 읽어올 수 있다                                                                            | Edu4 | Storage-File                            | App Component 구성 역량  |
| App Component 구성 역량  | room을 이용해서 데이터를 저장하고 읽어올 수 있다                                                                  | Edu4 | Storage-Room                            | App Component 구성 역량  |
| App Component 구성 역량  | SQLite (Database)를 이용해서 DB의 데이터를 저장하고 읽어볼 수 있다                                                 | Edu4 | Storage-Storage                         | App Component 구성 역량  |
| App Component 구성 역량  | 앱의 특성에 따라서 Service와 Intent서비스를 구분해서 적절한 Component를 적용한다                                        | Edu5 | Service                                 | App Component 구성 역량  |
| App Component 구성 역량  | DB schema version 변경에 따른 DB upgrade 등을 적용한다.                                                   | Edu5 | Storage-Room                            | App Component 구성 역량  |
| Architecture 설계 역량   | Dependency Injection 튜토리얼이나 sample코드를 오류 없이 생성하고 실행한다                                          | Edu1 | Architecture-Dependency Injection       | Architecture 설계 역량   |
| Architecture 설계 역량   | 튜토리얼이나 sample코드에서 일부 코드를 수정해서 기능을 확장/변형하고 오류가 없도록 실행한다                                         | Edu2 |                                         | Architecture 설계 역량   |
| Architecture 설계 역량   | 오류가 발생하는 경우 검색 또는 주변의 도움을 받아서 문제를 해결한다.                                                        | Edu3 | Architecture-Dependency Injection       | Architecture 설계 역량   |
...
| Productivity 활용 역량   | Cache나 library에서 제공하는 부가 기능 설정을 통해서 최적화를 한다                                                    | Edu5 | 3rd party library-Image Library (Glide) | Productivity 활용 역량   |
...
| User interface 개발 역량 | 여러개의 LinearLayout을 계층적으로 사용한다                                                                  | Edu3 | layout-layout                           | User interface 개발 역량 |
...
| 개발 도구 활용 역량          | Refactor 기능을 자유롭게 사용한다                                                                         | Edu4 | Android Studio                          | 개발 도구 활용 역량          |
