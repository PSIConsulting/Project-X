...
| 세분류          | 경험                                                                             | 학습수준 | 지식/스킬                                                 |
| ------------ | ------------------------------------------------------------------------------ | ---- | ----------------------------------------------------- |
| 개발환경 사용 역량   | 타깃을 추가하거나 소스 파일을 관리할 수 있다.                                                     | Edu2 | A-개발환경 (XCode)                                        |
...
| 개발환경 사용 역량   | 아카이브 동작을 위해서 목적지 설정하고 아카이브를 할 수 있다.                                            | Edu3 | A-개발환경 (통합배포)                                         |
| 개발환경 사용 역량   | 자신만의 패키지를 생성하고 다른 프로젝트에 추가할 수 있다.                                              | Edu3 | I-개발환경 (패키지관리)                                        |
| 개발환경 사용 역량   | 의존성 관리도구를 활용하여 외부 라이브러리를 가져와 사용한다.                                             | Edu3 | J-개발환경 (의존성 관리도구(SPM, CocoaPods, Cartage 등))          |
| 개발환경 사용 역량   | 브레이크 포인터를 지정하고 LLDB 명령으로 디버깅을 할 수 있다.                                          | Edu3 | P-개발환경 (XCode)                                        |
| 개발환경 사용 역량   | 빌드 에러를 확인하고 적절한 파일을 수정해서 오류를 고칠 수 있다.                                          | Edu3 | 개발환경 (XCode)                                          |
| 개발환경 사용 역량   | 앱스토어에 앱을 배포할 수 있다.                                                             | Edu4 | B-개발환경 (App Store)                                    |
| 개발환경 사용 역량   | 아카이브 완료 이후에 앱 스토어에 배포를 위해서 업로드 할 수 있다.                                         | Edu4 | B-개발환경 (통합배포)                                         |
| 개발환경 사용 역량   | 다른 오픈소스를 수정하고 기여할 수 있다.                                                        | Edu4 | D-개발환경 (패키지관리)                                        |
| 개발환경 사용 역량   | 오픈소스 패키지 의존성을 관리할 수 있다.                                                        | Edu4 | J-개발환경 (패키지관리)                                        |
| 개발환경 사용 역량   | 빈 프로젝트 템플릿으로 원하는 앱 구조를 만들도록 프로젝트를 설정 - 인스트루먼트로 메모리 누수나 최적화 상태를 디버깅할 수 있다.      | Edu4 | 개발환경 (XCode)                                          |
| 개발환경 사용 역량   | Test Target Scheme을 활용하여 테스트 앱을 배포할 수 있다.                                      | Edu5 | A-개발환경 (배포)                                           |
| 개발환경 사용 역량   | Xcode Server, Fastlane 등의 배포 툴을 통해 앱 배포를 자동화한다.                                | Edu5 | H-개발환경 (배포 자동화)                                       |
| 개발환경 사용 역량   | 통합 배포 환경을 구축할 수 있다.                                                            | Edu5 | H-개발환경 (통합배포)                                         |
...
| 프레임워크 사용 역량  | 키체인에 중요한 데이터를 읽고 쓸 수 있다.                                                       | Edu4 | N-프레임워크 (영구저장소)                                       |
